    ...
    <body>
        ...
        <div class="container" id="container">
            ...
            <div class="form-container sign-up-container">
                <form action="CadastrarCliente" class="Form-criar-conta" method="post" enctype="multipart/form-data" multiple=webkitdirectory=''>
            ...
            <div class="form-container sign-in-container">
                <a href="listarPet"> <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
